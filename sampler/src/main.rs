...
const ACTIVITY_CURVE: [f64; 24] = [
    0.071, 0.076, 0.088, 0.114, 0.162, 0.242,  // 00–05
    0.357, 0.503, 0.661, 0.808, 0.923, 0.991,  // 06–11
    0.968, 0.894, 0.938, 0.960, 1.000, 0.991,  // 12–17
    0.753, 0.537, 0.465, 0.418, 0.333, 0.226,  // 18–23
];
